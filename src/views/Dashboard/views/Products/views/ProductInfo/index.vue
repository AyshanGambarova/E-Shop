<template>
  <div class="bg-white px-8 py-6">
    <div class="pt-6 border border-slate-300 rounded-md border-black">
       <nav aria-label="Breadcrumb">
        <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
          <li>
            <div class="flex items-center">
              <span class="mr-2 text-sm font-medium text-gray-900">{{ product.category }}</span>
           ...
           <li>
            <div class="flex items-center">
              <span class="mr-2 text-sm font-medium text-gray-900">{{ product.title }}</span>
              <svg width="16" height="20" viewBox="0 0 16 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="h-5 w-4 text-gray-300">
                <path d="M5.697 4.34L8.98 16.532h1.327L7.025 4.341H5.697z" />
              </svg>
            </div>
          ...
          <li class="text-sm">
            <span aria-current="page" class="font-medium text-gray-500 hover:text-gray-600">{{ product.brand }}</span>
          </li>
        </ol>
      </nav> 
      <!-- Image gallery -->
      <div class="mx-auto px-4 pt-10 pb-16 sm:px-6 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-4">
        <div
